...
export const Sidebar = ({ user, impersonatedRole, onImpersonate }: SidebarProps) => {
                ...
                <li className="pt-4">
                  ...
                  {userRoles.map((userRole) => (
                    <Button
                      ...
                      className={cn(
                        ...
                        impersonatedRole === userRole.role ? "bg-primary text-primary-foreground" : ""
                      )}
                  ...
                  {impersonatedRole && (
                    <Button 
                      variant="outline" 
                      size="sm" 
                      className="w-full justify-start mt-2 text-xs"
