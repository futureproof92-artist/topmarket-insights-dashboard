...
export const HistorialSemanal = ({
  ...
  return <div className="space-y-4">
      ...
      {historial.length > 0 ? <Accordion type="single" collapsible className="w-full">
          {historial.map((item, index) => <AccordionItem key={`semana-${index}`} value={`semana-${index}`} className="border rounded-lg mb-4 overflow-hidden">
              ...
              <AccordionContent>
                <div className="p-4 space-y-6">
                  ...
                  {item.ventasDetalle.length > 0 && <div className="overflow-x-auto">
                      ...
                      <Table>
                        ...
                        <TableBody>
                          {item.ventasDetalle.map(venta => <TableRow key={venta.id}>
